...
impl Content {
    pub fn id(&self) -> Result<DocumentId> {
        let source = match self {
            ...
            Content::Relation(relation) => encode_to_vec(relation, config::standard())
                .with_context(|| {
                    format!(
    ...
    ($sweater_name:ident(
        ...
        pub mod $sweater_name {
            use {
                ...
                $crate::{
                    Text, RawText, Alias, Reference, Relation, RelationKind, Tag, Content, Thesis, AliasesResolver, Command, ReadTransactionMethods,
...
mod tests {
    ...
    use {
        crate::{
            AliasesResolver, Command, Content, GraphGenerator, GraphGeneratorConfig,
            ReadTransactionMethods, Relation, Tag, Text, Thesis,
        },
        fallible_iterator::FallibleIterator,
        nanorand::{Rng, WyRand},
